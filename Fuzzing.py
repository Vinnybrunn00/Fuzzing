...
def Banner():
    ...
    if sys.platform == 'linux':
        print(
            f'[bold][italic]{banner}[/] Version 2.0 \t OS: [italic][bold][cyan]Linux[/]\n\n')

    elif sys.platform == 'darwin':
        print(
            f'[bold][italic]{banner}[/] Version 2.0 \t OS: [italic][bold][cyan]MacOS[/]\n\n')

    elif sys.platform == 'win32':
        print(
            f'[bold][italic]{banner}[/] Version 2.0 \t OS: [italic][bold][cyan]Windows[/]\n\n')
